...
[![PyPI](https://img.shields.io/pypi/v/cognis-consentledger.svg)](https://pypi.org/project/cognis-consentledger/)
[![CI](https://github.com/cognis-digital/consentledger/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/consentledger/actions)
...
CONSENTLEDGER exists for one job — maintain a tamper-evident, hash-chained audit log of patient-data access and consent events. — and does it without a SaaS bill or heavyweight setup.
...
consentledger scan .                      # scan the current project
consentledger scan . --format json
consentledger scan . --fail-on high       # non-zero exit for CI gates
consentledger mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **sigstore/rekor + git**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`consentledger` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
