# Ports of consentledger

The same scan logic, ported across languages so you can drop consentledger into any stack
or ship a single static binary. All ports share the rule IDs and JSON output shape.

| Language | Path | Run |
|---|---|---|
| Python (reference) | `../consentledger/` | `consentledger scan .` |
