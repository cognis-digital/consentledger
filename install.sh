#!/usr/bin/env sh
# Universal installer for consentledger. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/consentledger.git"
echo "Installing consentledger ..."
...
echo "Done. Run: consentledger --help"
